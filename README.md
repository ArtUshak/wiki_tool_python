...
**Note**: list file format is same as format of file generated by `list-directory-pages` command.
...
*   `User:ArtushakBot/Test/Test1.txt` with text from `../data/wiki-pages/Test/Test1.txt`
